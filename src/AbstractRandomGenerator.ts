...
export default abstract class RandomGenerator {
  createWithSeeds(...seeds: number[]): RandomGenerator {
   ...
   * @locus Anywhere
   * @param {Number} charsCount Optional length of the secret string (defaults to 43
   *   characters, or 256 bits of entropy)
   */
  secret(charsCount: number = 43) {
